...
function update() {
  ...
  if (!autoMode) {
    ...
    if (moveLeft) jugador.body.velocity.x = -300; // Aumenta la velocidad del jugador
    if (moveRight) jugador.body.velocity.x = 300; // Aumenta la velocidad del jugador
    if (moveUp) jugador.body.velocity.y = -300; // Aumenta la velocidad del jugador
    if (moveDown) jugador.body.velocity.y = 300; // Aumenta la velocidad del jugador
    ...
    jugador.body.velocity.x = (moveRight - moveLeft) * 300; // Aumenta la velocidad del jugador
    jugador.body.velocity.y = (moveDown - moveUp) * 300; // Aumenta la velocidad del jugador
  }
  ...
  console.log(
    '-------------- DATOS DE MOVIMIENTO --------------\n' +
      'Movimiento en Izquierda: ',moveLeft + '\n' 
      + 'Movimiento en Derecha: ', moveRight + '\n' 
      + 'Movimiento hacia Arriba: ',moveUp + '\n' 
      + 'Movimiento hacia Abajo: ', moveDown + '\n')
